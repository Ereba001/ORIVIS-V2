...
export const pageMeta: Record<string, PageMeta> = {
  ...
  "/workspace/signin": {
    title: "Workspace Sign In | ORIVIS",
  ...
  "/platform/users": {
    title: "Users — Platform | ORIVIS",
    description: "View and manage all users on the ORIVIS platform.",
    noindex: true,
  },
  "/platform/memberships": {
    title: "Memberships — Platform | ORIVIS",
    description: "Manage organization memberships across the platform.",
    noindex: true,
  },
  "/platform/elections": {
