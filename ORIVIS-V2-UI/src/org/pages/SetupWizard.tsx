              ...
              <DashboardCard hover={false}>
                <div className="flex flex-col items-center text-center py-6">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.99 }}
                    className="mt-8 inline-flex items-center gap-2 px-8 py-3 rounded-xl text-xs font-bold uppercase tracking-widest shadow-md"
                ...
                <div className="bg-brand-surface border border-brand-border rounded-xl p-4 space-y-2">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="flex items-center gap-1.5">
                      ...
                      <span className="text-brand-text-primary font-mono">{branding.primaryColor}</span>
                    </span>
                  </div>
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="flex items-center gap-1.5">
                      ...
                      <span className="text-brand-text-primary font-mono">{branding.secondaryColor}</span>
                    </span>
                  </div>
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="flex items-center gap-1.5">
                      ...
                      <span className="text-brand-text-primary font-mono">{branding.accentColor}</span>
                    </span>
                  </div>
                </div>
